...
public class PrimitiveStreams
{
   public static void main(String[] args)
   {
      ...
      System.out.println("The sum of a stream of ints from an array: "
         + stream.sum());
      ...
      System.out.println("The Unicode code points of the string Hello: "
         + Arrays.toString(codePoints.toArray()));
